...
You can find information and configuration for each of the supported integrations on the [Service Widgets](https://gethomepage.dev/en/configs/service-widgets/) page.
